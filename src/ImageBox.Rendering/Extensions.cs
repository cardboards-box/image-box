...
public static class Extensions
{
    ...
    public static float DetermineFontSize(this string text, Rectangle rect, float padding, TextOptions options)
    {
    ...
    /// <returns>The size of the font</returns>
    public static float DetermineFontSize(this string text, Rectangle rect, float padding, Font font)
    {
    ...
    public static Font GetFont(this IPositionElement element, string text, ContextScope context)
    {
        ...
        var minFontSize = DetermineFontSize(text, rect, padding, font);
