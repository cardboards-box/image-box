...
| [Type](#type-ImageBox-Rendering-Directives-ForEachDir) | `ForEachDir` | Represents a for-each directive |
| [Type](#type-System-Boolean) | `Boolean` |  |
| [Type](#type-ImageBox-Rendering-Directives-IfDir) | `IfDir` | If directive for templates |
| [Type](#type-System-Double) | `Double` |  |
| [Type](#type-ImageBox-Rendering-Directives-RangeDir) | `RangeDir` | Represents a for directive |
| [Type](#type-ImageBox-Rendering-Renderers-ClearElem) | `ClearElem` | The clear element |
...
| [Type](#type-ImageBox-Rendering-Renderers-ImageElem) | `ImageElem` | Represents an image that can be drawn to the image |
| [Type](#type-ImageBox-Rendering-Renderers-RectangleElem) | `RectangleElem` | Represents a rectangle that can be filled or bordered |
...
| [Type](#type-ImageBox-Rendering-Renderers-TextElem) | `TextElem` | Represents text to be drawn to the image |
...
| [Type](#type-ImageBox-Rendering-Animations-Bezier-BezierAnimationElem) | `BezierAnimationElem` | Renders the children of the element with a Bezier animation |
| [Type](#type-ImageBox-Rendering-Animations-PointElem) | `PointElem` | Represents a point in the render context |
| [Type](#type-ImageBox-Elements-FontFamilyElem) | `FontFamilyElem` | Element to allow for importing of custom fonts |
| [Type](#type-ImageBox-Elements-RemoteResourceElem) | `RemoteResourceElem` | Represents a remote resource that should be cached |
| [Type](#type-ImageBox-Elements-ScriptElem) | `ScriptElem` | Represents a script that can be executed to calculate contexts |
| [Type](#type-ImageBox-Core-TimeUnits-TimeUnit) | `TimeUnit` | Unit of time. (ex: 20ms, 3.2s, 1m, 2h) |
| [Type](#type-System-UInt16) | `UInt16` |  |
| [Type](#type-ImageBox-Elements-TemplateElem) | `TemplateElem` | Represents the root of a template |
| [Type](#type-ImageBox-Elements-ResourcesElem) | `ResourcesElem` | Element to allow for caching resources to use across multiple renders |
